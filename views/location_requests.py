...
def delete_location(id):
    """removes the location with given id form the list"""
...
def update_location(id, new_location):
    """finds location based on id, and then replaces that indexed location with the new location"""
